...
\begin{align*}
T_{Raum}&=\frac{273,15K\cdot p_{R}}{p_E}=294,68K\\
\Delta T_{sys}&=\big|\frac{\delta T_{Raum}}{\delta p_{R}}\big| \cdot \Delta p_{R}+\big|\frac{\delta T_{Raum}}{\delta p_{E}}\big| \cdot \Delta p_{Raum}=2,32K
\end{align*}
Außerdem wurde die Siedetemperatur mithlife der Formel aus dem Versuchsraum zu $\theta_b =99,55°C$ bestimmt, woraus sich für den systematischen Fehler ergibt
$\theta_b =|\frac{\delta \theta_b}{\delta b}| \cdot \Delta b=0,037°C$.\\
...
&=3,62\cdot 10^{-3}\frac{1}{°C}\\
\Delta \alpha_{unk}&=9,80\cdot 10^{-5}\frac{1}{°C}
\end{align*}
...
\alpha&=\frac{\Delta p_K - \Delta p_E}{\Delta p_E}\cdot \frac{1}{\theta_b}+\frac{p_K}{p_E}\left( \gamma+\frac{V_K}{V_R}\cdot \frac{1}{T}\right)\\
&=3,66\cdot 10^{-3}K^{-1}\\
\Delta \alpha_{sys}&=|\frac{\delta \alpha}{\delta \alpha_{unkorr}}|\Delta \alpha_{unkorr}+|\frac{\delta \alpha}{\delta p_K}|\Delta p_K+|\frac{\delta \alpha}{\delta p_E}|\Delta p_E+|\frac{\delta \alpha}{\delta V_K}|\Delta V_K+|\frac{\delta \alpha}{\delta V_R}|\Delta V_R+|\frac{\delta \alpha}{\delta T}|\Delta T\\
&=9,85\cdot 10^{-5} K^{-1}\\
...
\begin{align*}
  ...
  &= \left| \dfrac{h_1 + h_2}{(h_1 - h_2)^2} \right| \cdot \Delta h
\end{align*}
...
\begin{align*}
  \kappa = \dfrac{1}{4}\sum\limits_{i=1}^4 \kappa_i = 1,318 \pm 0,045
\end{align*}
berechnet. 

Mit der Messunsicherheit 
\begin{align*}
  u &= \dfrac{S}{\sqrt{N}} = \sqrt{\dfrac{1}{N(N-1)}\sum\limits_i (\kappa_{i}-\kappa)^2 } \\
 &= 0,005
\end{align*}
